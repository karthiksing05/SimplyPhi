...
if __name__ == "__main__":
    ...
    # Train the model
    phi_train_losses, phi_val_losses = train_model(phi_model, train_dataset, val_dataset, epochs=NUM_EPOCHS, learning_rate=0.01, split=0.9999)
    ...
    train_losses, val_losses = train_model(model, train_dataset, val_dataset, epochs=NUM_EPOCHS, learning_rate=0.01, split=0.0)
    # print(train_losses, val_losses)

    with open("phiPlusLossTest100.pickle", "wb") as f:
