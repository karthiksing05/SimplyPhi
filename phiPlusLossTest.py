...
if __name__ == "__main__":
    ...
    # Train the model
    phi_train_losses, phi_val_losses = train_model(phi_model, train_dataset, val_dataset, epochs=NUM_EPOCHS, learning_rate=0.01, split=0.7)
    ...
    with open("phiPlusLossTest.pickle", "wb") as f:
